import { RESET, PROCESSING, UPDATE_SEARCH_PRIVATE_CHATLIST, SET_SEARCH_PRIVATE_CHATLIST_NEXTURL } from "../actions/types";
...
const SearchPrivateChatListReducer = (state = INITIAL_STATE, action) => {
    ...
    switch (action.type) {
        ...
        case PROCESSING:
            ...
            break;
        case RESET:
            return action.payload.key == "searchprivatechatlist" ? INITIAL_STATE : state;
            break;
        default:
            return state;
            break;
