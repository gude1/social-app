...
export const SET_POST_COMMENT_FORM_OWNER_POST = 'set_post_comment_form_owner_post';
export const UPDATE_POST_COMMENT_FORM_OWNER_POST = 'update_post_comment_form_owner_post';
...
export const SET_POST_COMMENT_REPLY_FORM_OWNER_COMMENT = 'set_post_comment_reply_form_owner_comment';
export const UPDATE_POST_COMMENT_REPLY_FORM_OWNER_COMMENT = 'update_post_comment_reply_form_owner_comment';
...
export const UPDATE_USER_VIEWPROFILEFORM_POSTS_ARRAY = 'update_user_viewprofileform_posts_array';
...
export const UPDATE_OTHERS_VIEWPROFILEFORM_POSTS_ARRAY = 'update_others_viewprofileform_posts_array';
export const SET_OTHERS_VIEWPROFILEFORM_POSTS = 'set_others_viewprofileform_posts';
