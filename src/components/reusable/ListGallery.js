...
function Item({ item, selected, onSelect, placeholdercolor, colors, height, width }) {
    return (
        <TouchableOpacity
            onPress={() => onSelect(item.caption)}
        >
            <Image
...
function ListGallery({ colors, dimensions, navigator, selected, photoList, placeholdercolor, selectAction }) {
