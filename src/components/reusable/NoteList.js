      ...
      case 'postshare':
        ...
        count_msg =
          item.related_count > 0
            ...
            : `${item.initiator_profile.profile_name} shared your post`;
        onPress = () => {
          Navigation.showModal({
            component: {
              name: 'PostShow',
...
export class MentionsList extends Component {
  ...
  renderItem = ({item}) => {
    ...
    return this._arrangeMentions(item);
  };
  ...
  _arrangeMentions = item => {
    ...
    switch (item.type) {
      case 'postmention':
        msg = `${
          item?.initiator_profile?.profile_name
      ...
      case 'postcommentmention ':
        msg = `${
          item?.initiator_profile?.profile_name
        } mentioned you in a postcomment`;
        onPress = () => {
          Navigation.showModal({
            component: {
              name: 'PostComment',
      ...
      case 'profilebiomention':
        msg = `${
          item?.initiator_profile?.profile_name
        } mentioned you in a profile bio`;
        onPress = () => {
          Navigation.showModal({
            component: {
              name: 'ViewProfile',
