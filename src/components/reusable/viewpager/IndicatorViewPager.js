...
import ViewPagerAll from './ViewPagerAll'

export default class IndicatorViewPager extends Component {
    static propTypes = {
        ...ViewPagerAll.propTypes,
    ...
    render() {
        return (
            <View style={[styles.container, this.props.style]} >
                {this.props.indicatorposition == "top" && this._renderIndicator()}
                <ViewPagerAll
                    {...this.props}
                ...
                />
                {this.props.indicatorposition == "bottom" && this._renderIndicator()}
            </View>
        )
    }
